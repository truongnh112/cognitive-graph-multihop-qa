...
def main(output_model_file = './models/bert-base-uncased.bin', load = False, mode = 'tensors', batch_size = 8, 
    ...
    with open('/content/drive/MyDrive/CogQA/CogQA/examples/hotpot_train_v1.1_refined_50k.json' ,'r') as fin:
